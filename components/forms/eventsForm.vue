<template>
	<div class="my-form-style">
		<FormKit v-model="state" type="form" :config="{ validationVisibility: 'live' }" submit-label="Submit"
			...
			<FormKit label="Event Name" name="event_title" type="text" autofocus validation="required" />
			<FormKit label="Description" name="event_description" type="textarea" validation="required" />
			<FormKit label="Location" name="event_location" type="textarea" validation="required" />
			<FormKit type="date" label="Event Date" name="event_dt" validation="required" />
			<FormKit type="date" label="Release Date" name="release_dt" validation="required" />
			<FormKit type="date" label="Expire Date" name="expire_dt" validation="required" />
