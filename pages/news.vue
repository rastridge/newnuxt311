	...
	<div>
		...
		<div class="my-simple-card-style">
					...
					<div>
						...
						<blockquote class="instagram-media"
							...
							<div style="padding: 16px">
								<a href="https://www.instagram.com/buffalorugbyclub/?utm_source=ig_embed&amp;utm_campaign=loading"
									style="
										background: #ffffff;
										line-height: 0;
										padding: 0 0;
								...
								<p style="
									...
									<a href="https://www.instagram.com/buffalorugbyclub/?utm_source=ig_embed&amp;utm_campaign=loading"
										style="
											...
											font-weight: normal;
											line-height: 17px;
										" target="_blank">Buffalo Men&#39;s Rugby Club</a>
									(@<a href="https://www.instagram.com/buffalorugbyclub/?utm_source=ig_embed&amp;utm_campaign=loading"
										style="
											color: #c9c8cd;
											font-family: Arial, sans-serif;
											...
											font-weight: normal;
											line-height: 17px;
										" target="_blank">buffalorugbyclub</a>) • Instagram photos and videos
								</p>
							</div>
						</blockquote>
					</div>
			...
			<div
				...
				<Card v-for="item in news" :key="item.news_id" style="width: 320px" class="flex justify-content-center">
					<template #title>
						<span class="text-sm">
							{{ $dayjs(item.dt).format('MMM D, YYYY') }} </span><br />
						<span>
							{{ item.news_title }}
						</span>
					</template>
					...
					<template #footer>
						<a href="#" @click.prevent="openModal(item)"><span class="m-2">Read More</span></a> <span
		...
		<Dialog v-model:visible="displayModal" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
			...
			<template #footer>
				<div>
					<Button label="Return" class="p-button-sm" autofocus @click="closeModal" />
				</div>
			</template>
		</Dialog>
	</div>
